...
public class MessageController {
    ...
    public ResponseEntity<Object> sendMessage(@RequestBody SendMessageRequest sendMessageRequest) {
        // messageService.sendMessage(sendMessageRequest.getAccessToken(),
        // sendMessageRequest.getSendTo(), sendMessageRequest.getMessage());

        ObjectMapper mapper = new ObjectMapper();

        try {
            messageSender.send("my-topic", mapper.writeValueAsString(sendMessageRequest));
